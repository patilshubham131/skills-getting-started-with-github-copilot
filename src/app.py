...
activities = {
    ...
    "Science Olympiad": {
        ...
        "max_participants": 14,
        "participants": ["evelyn@mergington.edu", "sophia@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice public speaking, research, and formal debates",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["logan@mergington.edu", "jackson@mergington.edu"]
    }
}
...
def unregister_participant(activity_name: str, email: str):
    ...
    if email not in activity["participants"]:
        return {"message": f"{email} is not registered for {activity_name}"}
